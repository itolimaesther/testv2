...
import SubscriptionSuccess from "./modals/SubscriptionSuccess";
	...
	return (
		<div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
			<div className="flex flex-col lg:w-full p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800 dark:text-white">
				...
				<button
					type="button"
					className="inline-block text-white px-5 py-3 font-semibold tracki text-center bg-[#36B3A5] rounded dark:bg-violet-400 dark:text-gray-900"
				>
					Current Plan
				</button>
			</div>
			...
			<SubscriptionSuccess isOpen={isModalOpen} onClose={closeModal} />
		</div>
	);
}
