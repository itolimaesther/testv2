...
function SubscriptionFailed({ isOpen, onClose }: SubscriptionFailedProps) {
	if (!isOpen) {
		return null;
	}
		...
		<div className="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-gray-800 bg-opacity-50 z-50">
			<div className="bg-white p-6 rounded-lg w-[483px]">
				...
				<div className="flex flex-col justify-center py-3 items-center">
					<h3 className="text-[#EB5757] text-2xl py-8">Transaction Failed</h3>
					<p className="text-sm text-gray-400 mb-4">
						You currently do not have sufficient balance to complete this
						transaction
					</p>

					<p className="text-xs text-gray-20">
						You can fund your wallet to continue{" "}
					</p>
					<button
						type="button"
