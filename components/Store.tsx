	...
	return (
		<>
			...
			<div className="grid grid-cols-1 pt-6 xl:grid-cols-5 xl:gap-4 dark:bg-gray-900">
				<div className="xl:col-span-2 w-full md:w-full mt-6 py-7 px-5 xl:mt-0 lg:col-auto bg-white rounded-lg">
					<h3 className=" text-lg w-full font-semibold ">
						Top Selling Category
					</h3>
					<p className="text-gray-200 ">Total 10.4k Visitors</p>
				</div>
				<div className="xl:col-span-3 w-full md:w-full mt-6 py-7 px-5 xl:mt-0 lg:col-auto bg-white rounded-lg">
					<div className="xl:flex w-full justify-center items-center space-x-4 ">
						<h3 className=" text-lg w-full font-semibold ">
							Last Transactions
						</h3>
						...
						<table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
							...
							<tbody>
								<tr className="bg-white border-b dark:bg-gray-100 dark:border-gray-700 hover:bg-gray-10 dark:hover:bg-gray-600">
									...
									<td className="px-6 py-4">31 March 2023</td>
			...
			<div className="grid grid-cols-1 pt-6 xl:grid-cols-5 xl:gap-4 dark:bg-gray-900">
				...
				<div className="xl:col-span-2 w-full md:w-full mt-6 py-7 px-5 xl:mt-0 lg:col-auto bg-white rounded-lg">
					<h3 className=" text-lg w-full font-semibold ">Sales by Chanel</h3>

					<div>
						<div className="xl:flex w-full items-center space-x-4 mt-5">
							<div className="xl:w-[50%]">
								<p className=" text-sm w-full font-semibold ">
									Online Store Front
								</p>
								<p className="text-gray-500">avg. ₦205.56 per month</p>
							</div>
							<div className="xl:w-[50%] xl:text-end">
								<span className=" text-sm  ">₦1,553,999.29</span>
							</div>
						</div>
						<div className="xl:flex w-full items-center space-x-4 mt-5">
							<div className="xl:w-[50%]">
			...
			<div className="grid grid-cols-1 pt-6 xl:grid-cols-5 xl:gap-4 dark:bg-gray-900">
				<div className="xl:col-span-2 w-full md:w-full mt-6 py-7 px-5 xl:mt-0 lg:col-auto bg-white rounded-lg">
					<h3 className=" text-lg w-full font-semibold ">Today Order</h3>
					<p className="text-gray-200 ">Total 10.4k Visitors</p>
				</div>
				<div className="xl:col-span-3 w-full md:w-full mt-6 py-7 px-5 xl:mt-0 lg:col-auto bg-white rounded-lg">
					<div className="xl:flex w-full justify-center items-center space-x-4 ">
						<h3 className=" text-lg w-full font-semibold ">Recent Orders</h3>
					</div>
